...
path_dict["CO"] = "N2_K3_CO_usage_defrost_cycles.csv"
path_dict["FHMM"] = "N2_K3_FHMM_usage_defrost_cycles.csv"
...
for i, (algo_name, algo_path) in enumerate(path_dict.iteritems()):
    ...
    print "Outlier", len(df_outlier)
    print "Feedback", len(df_feedback)
    #print "True feedback", len()
