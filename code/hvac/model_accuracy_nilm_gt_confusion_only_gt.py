...
fig.text(0.55, 0.0, 'Predicted labels', ha='center')
fig.tight_layout()
plt.savefig(os.path.expanduser("~/git/nilm-actionable/figures/hvac/hvac_feedback_confusion_gt.pdf"),bbox_inches="tight")
plt.show()
